...
Evidence: 历史构建提示词；当前实施以需求文档/市级学生智能问答助手_PRD_v1.0.md 和开发/PRD/21-25 为准。
...
所有 PRD 文档位于：`/Users/hao/智能问答助手/开发/PRD/`
...
本文不再作为当前开发任务提示词。新的实现应从 [PRD-21：V2 阶段 0—1 实施计划](PRD/21_阶段一实施计划.md) 开始，并以 [市级学生智能问答助手 PRD v1.0](../需求文档/市级学生智能问答助手_PRD_v1.0.md) 为唯一产品基线；每个阶段必须按照 PRD-25 的证据门禁验收。
