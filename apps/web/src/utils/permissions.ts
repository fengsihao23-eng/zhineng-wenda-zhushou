...
export const SCHOOL_ROLES = ['SCHOOL_ADMIN', 'QA', 'SCHOOL_VIEWER']
export const CITY_ROLES = ['CITY_OPERATOR', 'SUPER_ADMIN']
export const ALL_ROLES = [...STUDENT_ROLES, ...TEACHER_ROLES, ...SCHOOL_ROLES, ...CITY_ROLES, 'EXAM_ADMIN']
...
export function homePath(user: UserInfo | null): string {
  ...
  if (hasAnyRole(user, ['EXAM_ADMIN'])) return '/admin/school'
